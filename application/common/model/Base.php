...
class Base extends Model
{
    ...
    public function randData()
    {
        $arr = [
            ...
            ["nick_name" => "陈近南", "user_img" => "default.png"],
            ["nick_name" => "韦小宝", "user_img" => "default.png"],
            ["nick_name" => "令狐冲", "user_img" => "default.png"],
            ["nick_name" => "任我行", "user_img" => "default.png"],
            ["nick_name" => "杨过", "user_img" => "default.png"],
            ["nick_name" => "张无忌", "user_img" => "default.png"],
            ["nick_name" => "张三丰", "user_img" => "default.png"],
            ["nick_name" => "郭靖", "user_img" => "default.png"],
            ["nick_name" => "周伯通", "user_img" => "default.png"],
            ["nick_name" => "黄药师", "user_img" => "default.png"],
            ["nick_name" => "洪七公", "user_img" => "default.png"],
            ["nick_name" => "段誉", "user_img" => "default.png"],
            ["nick_name" => "虚竹", "user_img" => "default.png"],
            ["nick_name" => "乔峰", "user_img" => "default.png"],
            ["nick_name" => "逍遥子", "user_img" => "default.png"],
            ["nick_name" => "达摩祖师", "user_img" => "default.png"],
            ["nick_name" => "一灯大师", "user_img" => "default.png"],
            ["nick_name" => "扫地僧", "user_img" => "default.png"],
            ["nick_name" => "陈家洛", "user_img" => "default.png"],
            ["nick_name" => "袁承志", "user_img" => "default.png"],
            ["nick_name" => "胡斐", "user_img" => "default.png"],
            ["nick_name" => "苗人凤", "user_img" => "default.png"],
            ["nick_name" => "石破天", "user_img" => "default.png"],
            ["nick_name" => "狄云", "user_img" => "default.png"],
            ["nick_name" => "胡一刀", "user_img" => "default.png"],
            ["nick_name" => "范蠡", "user_img" => "default.png"],
            ["nick_name" => "袁冠南", "user_img" => "default.png"],
        ];
